...
namespace MEASWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Test()
        {
            ...
            var responseJson = httpClient.PostAsync("http://nutritrac.abbott.com.sg/API/Share/SendEmailOnSummaryPage", httpContent).Result.Content.ReadAsStringAsync().Result;
