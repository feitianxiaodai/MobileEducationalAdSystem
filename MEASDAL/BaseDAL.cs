...
namespace MEASDAL
{
   ...
   {
       static DbContext db = DbContextFactory.CreateDbContext();
       ...
       public List<T> GetListByDesc<TKey>(Expression<Func<T,bool>> whereLambda,Expression<Func<T,TKey>> orderLambda)
       {
